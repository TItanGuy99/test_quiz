            ...
            <div className="introduction-background">
                <div className="row setsize custom-padding-top-15">
                    ...
                    <div className="col-4">
                        ...
                        <p className="text-left padding-top-20 padding-bottom-20 text-regular">Seja bem-vindo(a)! A partir de agora,você terá a oportunidade de colocar em prática tudo o que já aprendeu. Para isso, será necessário superar alguns desafios, tomando a <span className="text-color-red"><strong>melhor decisão para você, para o cliente e para
o negócio.</strong></span> Está preparado?</p>
                        <div id="box-purple">
