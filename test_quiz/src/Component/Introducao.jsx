...
o negócio.</span> Está preparado?</p>
                        <div id="box-purple">
                            <h3 className="text-left text-color-white text-extra-bold text-size-22"><Link className="nav-link link" to="/Instrucao">Clique aqui para aceitar o desafio!</Link></h3>
                        </div>
                    </div>
